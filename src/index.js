...
const db = mongoose.createConnection("mongodb+srv://ajax:1234@doubts-overflow.jtd6s.mongodb.net/doubtsOverflow?retryWrites=true&w=majority", {
...
app.get('/', (req, res) => {
    res.status(200).send(" doubts-overflow backend server woking");
});
